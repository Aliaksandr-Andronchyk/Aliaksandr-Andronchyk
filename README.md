# 👋 Hi, I'm Sasha Andronchyk

**iOS & AI app developer** – I ship complete products end-to-end: idea → SwiftUI app → backend → TestFlight/App Store.

## ❤️ Favorite technologies

- Swift / SwiftUI
- Python · FastAPI · SQLAlchemy · PostgreSQL
- Claude / OpenAI APIs – agents, tool use, prompt pipelines
- Node.js
- Docker · GitHub Actions · Linux (GCP)
- WebSocket / REST · Telegram Bot API

## 🚀 What I've built

- **[lesson-booking-api](https://github.com/SashaAndronchyk/lesson-booking-api)** – booking REST API: FastAPI, async SQLAlchemy 2.0, PostgreSQL, Alembic, Docker, pytest, green CI
...
*Open to interesting projects – I like building things that actually ship.*
